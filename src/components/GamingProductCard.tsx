    ...
    `}>
      ...
      <div className="flex flex-col sm:flex-row items-stretch gap-3">
        ...
        {id && barcode_image_url && (
            <Link 
                to={`/pay-barcode/${id}`}
                className="w-full sm:w-auto flex-shrink-0 text-center text-white py-4 px-6 rounded-[5rem] border-[5px] text-lg leading-none tracking-wider transition-all duration-300 hover:cursor-pointer relative z-10 bg-gradient-to-r from-slate-600 to-gray-700 hover:from-slate-700 hover:to-gray-800 border-slate-500 hover:border-slate-400 flex items-center justify-center space-x-2"
            >
